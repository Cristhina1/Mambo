...
public class CarritoController {
    ...
    public CarritoController(DetalleCompraService detalleCarritoService, ClienteService clienteService) {
        this.detalleCarritoService = detalleCarritoService;
        this.clienteService = clienteService;
    }

    @PostMapping
    public ResponseEntity<ComprobanteDTO> guardarCarrito(@RequestBody ComprobanteDTO carritoDTO, Principal principal) {
        ...
        ComprobanteDTO resultado = detalleCarritoService.guardarCarrito(carritoDTO, c);
